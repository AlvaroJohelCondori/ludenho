...
@section('content')
    <div class="card">
        <div class="card-body">
            <form action="{{ route('admin.starts.update', $start) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col">
                        <x-adminlte-input name="start_title" label="Título Portada" placeholder="Títlo Portada"
                            label-class="text-lightblue" value="{{ $start->start_title }}">
                    ...
                    <div class="col">
                        <x-adminlte-input name="start_subtitle" label="Subtítulo Portada" placeholder="Subtítulo Portada..."
                            label-class="text-lightblue" value="{{ $start->start_subtitle }}">
                            <x-slot name="prependSlot">
                                <div class="input-group-text">
                                    <i class="fas fa-user text-lightblue"></i>
                                </div>
                    ...
                    <div class="col">
                        ...
                        <x-adminlte-input-color name="start_color" placeholder="Elija un color..." label="Seleccione Color"
                            label-class="text-lightblue" :config="$config" value="{{ $start->start_color }}">
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-radio">
                                <input class="custom-control-input" type="radio" id="customRadio1" name="start_state"
                                    value="1" {{ $start->start_state == 1 ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio">
                                <input class="custom-control-input" type="radio" id="customRadio2" name="start_state"
                                    value="2" {{ $start->start_state == 2 ? 'checked' : '' }}>
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <x-adminlte-input-file-krajee name="start_image" label="Seleccionar Foto"
                            data-msg-placeholder="Seleccione una imagen relacionada a la portada..."
